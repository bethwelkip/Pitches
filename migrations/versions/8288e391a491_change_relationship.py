...
Revision ID: 8288e391a491
Revises: daf4f4df84de
Create Date: 2020-10-31 17:27:27.054970
...
revision = '8288e391a491'
down_revision = 'daf4f4df84de'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_foreign_key(None, 'pitches', 'users', ['user_id'], ['userid'])
...
def downgrade():
    ...
    op.create_foreign_key('users_pitch_id_fkey', 'users', 'pitches', ['pitch_id'], ['pitch_id'])
